...
hidden if the `expense-tracquer_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `expense-tracquer_DEVELOPER_MODE` to the configure
...
Runs the executable target `expense-tracquer_exe`.
